...
- [ ] Explain what a token is used for.
      A token is held on to by the user when navigating a web page to declare their authentication state.
- [ ] What steps can you take in your web apps to keep your data secure?
      You can require certain content to be hidden behind a "logged in users only" wall.
- [ ] Describe how web servers work.
      Web servers are basically giant computers that hold our data and host it for us. Our computers send a request to the servers, the servers then send back data to our computers.
